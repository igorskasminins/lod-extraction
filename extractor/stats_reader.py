...
class StatsReader:
    ...
    def write_data(
        ...
        third_most_property_iri = '',
        third_most_property_count = '',
        third_most_property_object_count = '',
        fourth_most_property_iri = '',
        fourth_most_property_count = '',
        fourth_most_property_object_count = '',
        json_output_file = '',
        is_extraction_full = '',
        api_call_request = '',
        endpoint_origin = '',
        ...
        with open(f'./{extraction_statistics_output}', 'a', newline='') as csv_file:
            ...
            try:
                ...
                self.write_data(access_url=access_url)